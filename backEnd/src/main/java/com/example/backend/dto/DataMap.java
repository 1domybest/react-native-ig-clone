...
public class DataMap extends HashMap<String, Object> {
    ...
    public Integer[] getIntegerArr(Object key) {
        int[] intArr = this.getIntArr(key);
        if (intArr == null) {
            return null;
        }
    ...
    public String getStringFromArray(Object key, String identifier) {
        ...
        if (obj.getClass() == String[].class) {
            temp = String.join(identifier, (String[]) obj);
        } else if (obj.getClass() == String.class)
            temp = (String) obj;
        else
            temp = obj.toString();
    ...
    public void printAllValue() {
        final Map<String, Object> map = this;
        System.out.println("+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++");
        if (map.isEmpty()) {
    ...
    public List<Integer> getIntList(String key) {
        ...
        return list.stream().map(o -> Integer.valueOf(o.toString())).collect(Collectors.toList());
    }
    ...
    public List<DataMap> getDataMapList(String key) {
        Object  obj = this.get(key);
        List<?> list;
